...
var (
	...
	CustomRoleResource               = mustRead("resources/singlestoredb_custom_role/resource.tf")
	CustomRoleResourceIntegration    = mustRead("resources/singlestoredb_custom_role_integration/resource.tf")
	AllRolesListDataSource           = mustRead("data-sources/singlestoredb_all_roles/data-source.tf")
