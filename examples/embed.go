...
var (
	...
	WorkspaceIdentityDataSource      = mustRead("data-sources/singlestoredb_workspace_identity/data-source.tf")
	WorkspacePrivateConnections      = mustRead("data-sources/singlestoredb_workspace_private_connections/data-source.tf")
	WorkspacePrivateConnectionsKai   = mustRead("data-sources/singlestoredb_workspace_private_connections_kai/data-source.tf")
	WorkspacePrivateConnectionsOAL   = mustRead("data-sources/singlestoredb_workspace_private_connections_outbound_allow_list/data-source.tf")
