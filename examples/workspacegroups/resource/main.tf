...
resource "singlestore_workspace_group" "example" {
  ...
  firewall_ranges = ["192.168.0.1/32"] # Edit to the desired ranges.
  expires_at     = "2222-01-01T00:00:00Z"
  region_id      = data.singlestore_regions.all.regions.0.id # In production, prefer indicating the explicit region ID because the list of workspaces changes.
