...
subcategory: ""
description: |-
  Retrieve a specific workspace group using its name or ID with this data source.
---
...
- `project_id` (String) The unique identifier of the project to which the workspace group is assigned.
