		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					resource.TestCheckResourceAttr("singlestoredb_flow_instance.this", config.IDAttribute, testFlowInstanceID.String()),
					resource.TestCheckResourceAttr("singlestoredb_flow_instance.this", "name", testFlowInstanceName),
					resource.TestCheckResourceAttr("singlestoredb_flow_instance.this", "workspace_id", testWorkspaceID.String()),
					resource.TestCheckResourceAttr("singlestoredb_flow_instance.this", "endpoint", testFlowEndpoint),
