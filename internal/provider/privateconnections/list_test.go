...
func TestReadPrivateConnections(t *testing.T) {
	...
	privateConnections := []management.PrivateConnection{
		...
		},
		{
			...
			ServiceName:         util.Ptr(string("private")),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr("data.singlestoredb_private_connections.all", "private_connections.0.status", string("ACTIVE")),
					resource.TestCheckResourceAttr("data.singlestoredb_private_connections.all", "private_connections.0.type", string("OUTBOUND")),
					resource.TestCheckResourceAttr("data.singlestoredb_private_connections.all", "private_connections.0.workspace_id", string("fe10982b-c0b6-4c36-b8e7-ce56c5eb0636")),
