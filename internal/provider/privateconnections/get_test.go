		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr("data.singlestoredb_private_connection.this", "active_at", string("2025-01-21T11:11:38.145343Z")),
					resource.TestCheckResourceAttr("data.singlestoredb_private_connection.this", "allow_list", string("12345")),
					resource.TestCheckResourceAttr("data.singlestoredb_private_connection.this", "created_at", string("2025-01-21T11:11:38.145343Z")),
					resource.TestCheckResourceAttr("data.singlestoredb_private_connection.this", "endpoint", string("com.amazonaws.vpce.eu-central-1.vpce-svc-074a8eb58bb50c406")),
					resource.TestCheckResourceAttr("data.singlestoredb_private_connection.this", "outbound_allow_list", string("127.0.0.0")),
					resource.TestCheckResourceAttr("data.singlestoredb_private_connection.this", "service_name", string("test name")),
					resource.TestCheckResourceAttr("data.singlestoredb_private_connection.this", "status", string("ACTIVE")),
					resource.TestCheckResourceAttr("data.singlestoredb_private_connection.this", "type", string("INBOUND")),
					resource.TestCheckResourceAttr("data.singlestoredb_private_connection.this", "workspace_id", string("283d4b0d-b0d6-485a-bc2d-a763c523c68a")),
					resource.TestCheckResourceAttr("data.singlestoredb_private_connection.this", "workspace_group_id", string("a4df90a6-e2b2-4de6-a50e-bd0a05aeaa09")),
					resource.TestCheckResourceAttr("data.singlestoredb_private_connection.this", "updated_at", string("2025-01-21T11:11:38.145343Z")),
				),
			},
		},
	})
